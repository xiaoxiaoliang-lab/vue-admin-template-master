<template>
  <div class="app-container">
      ...
      <div>
        ...
        <!-- 事件触发，每次勾选复选框，就会将list值记录，当表格复选框选项发生变化的时候触发，调用handleSelectionChange方法 -->
      <el-table
...
export default {
   ...
   methods: {//定义方法，进行请求接口调用
    //医院设置列表
      getList(page=1) { //添加当前页参数,做分页查询
         this.current = page
         //因为已经引入src/api/hospset，所以直接hospset.出方法即可。
